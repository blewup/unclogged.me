...
CREATE TABLE IF NOT EXISTS visitors (
    ...
    first_name VARCHAR(100) DEFAULT NULL COMMENT 'First name (if provided)',
    last_name VARCHAR(100) DEFAULT NULL COMMENT 'Last name (if provided)',
    full_name VARCHAR(200) DEFAULT NULL COMMENT 'Full name (if provided)',
    email VARCHAR(255) DEFAULT NULL COMMENT 'Email address (if provided)',
    phone VARCHAR(50) DEFAULT NULL COMMENT 'Phone number (if provided)',
    gender VARCHAR(50) DEFAULT NULL COMMENT 'Gender (if provided)',
    age INT DEFAULT NULL COMMENT 'Age (if provided)',
    nationality VARCHAR(100) DEFAULT NULL COMMENT 'Nationality (if provided)',
    current_location VARCHAR(255) DEFAULT NULL COMMENT 'Current location (if provided)',
    last_purchase VARCHAR(255) DEFAULT NULL COMMENT 'Last purchase reference (if provided)',
    last_purchase_value DECIMAL(12,2) DEFAULT NULL COMMENT 'Last purchase value (if provided)',
    last_purchase_currency VARCHAR(10) DEFAULT NULL COMMENT 'Last purchase currency (if provided)',
    last_visited_site VARCHAR(512) DEFAULT NULL COMMENT 'Last visited website (if provided)',
    social_network VARCHAR(100) DEFAULT NULL COMMENT 'Social network source (if provided)',
    last_message TEXT DEFAULT NULL COMMENT 'Last message content (if provided)',
    ...
    geo_accuracy INT DEFAULT NULL COMMENT 'Geo: Accuracy in meters',
    ...
    client_hints JSON DEFAULT NULL COMMENT 'Serialized client hints/device data',
